...
def test_get_vacancies(mock_get):
    response_body = {
        'items': [
            {'name': 'Python Developer', 'salary': {'from': '1000'}, 'alternate_url': 'https://hh.ru/vacancy', 'snippet': {'requirement': 'Python', 'responsibility': 'Can code'}},
            {'name': 'Developer', 'alternate_url': 'https://hh.ru/vacancy', 'snippet': {'requirement': 'Thinking', 'responsibility': 'Can research'}},
        ]
    }
